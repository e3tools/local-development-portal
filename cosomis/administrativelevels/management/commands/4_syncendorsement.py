...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        village_priorities_tasks_name = [
            ...
            "Identification et établissement de la liste des besoins prioritaires pour la composante 1 (amélioration de l'accès des populations aux services sociaux de base)" # PURS
        ]
...
def update_or_create_priorities_document(priorities_document):
    ...
    administrative_levels = AdministrativeLevel.objects.filter(no_sql_db_id=adm_id)
