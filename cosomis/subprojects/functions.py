    ...
    if datas_file:
        ...
        while count < long:
            ...
            try:
                ...
                name_of_the_winning_company_enterprises_of_supply_of_furniture_and_equipment = get_value(datas_file["NOM DE L'ENTREPRISE ATTRIBUTAIRE ENTREPRISES DE FOURNITURE DE MOBILIERS ET EQUIPEMENTS (EFME)"][count])
                date_signature_contract_companies_supply_of_furniture_and_equipment = get_value(datas_file["DATE SIGNATURE CONTRAT ENTREPRISES DE FOURNITURE DE MOBILIERS ET EQUIPEMENTS (EFME)"][count])
                amount_of_the_contract_companies_for_the_supply_of_furniture_and_equipment = get_value(datas_file["MONTANT DU CONTRAT ENTREPRISES DE FOURNITURE DE MOBILIERS ET EQUIPEMENTS (EFME)"][count])
...
(Travaux en cours, Arrêt travaux, Abandon travaux, Réception technique, Réception provisoire etc,)"""][count])
                ...
                amount_of_care_and_maintenance_fund_raised_and_deposited_in_the_village_account = get_value(datas_file["MONTANT DU FONDS D'ENTRETIEN ET DE MAINTENANCE (EMI)  MOBILISE ET DEPOSE SUR LE COMPTE DU VILLAGE"][count])
                existence_of_a_maintenance_and_upkeep_plan_developed_by_the_Community = get_value(datas_file["""Existence d'un Plan d'Entretien et de Maintenance (Plan EMI) élaboré par la Communauaté 
(Si Oui mettre 1; Si non mettre 0)"""][count])
                ...
                technical_acceptance_date_for_furniture_and_equipment_supply_contracts = get_value(datas_file["DATES DE RECEPTION TECHNIQUE DES MARCHE DE FOURNITURE DE MOBILIERS ET EQUIPEMENTS"][count])
                ...
                provisional_acceptance_date_for_furniture_and_equipment_supply_contracts = get_value(datas_file["DATES DE RECEPTION PROVISOIRE DES MARCHE DE FOURNITURE DE MOBILIERS ET EQUIPEMENTS"][count])
                    ...
                    if not _is_object_error:
                        ...
                        if village == "CCD":
                            ...
                            for sub in subprojects:
                                if administrative_level_canton and not subproject.link_to_subproject:
                        ...
                        subproject.name_of_the_winning_company_enterprises_of_supply_of_furniture_and_equipment = name_of_the_winning_company_enterprises_of_supply_of_furniture_and_equipment
                        subproject.date_signature_contract_companies_supply_of_furniture_and_equipment = date_signature_contract_companies_supply_of_furniture_and_equipment
                        subproject.amount_of_the_contract_companies_for_the_supply_of_furniture_and_equipment = amount_of_the_contract_companies_for_the_supply_of_furniture_and_equipment
                        ...
                        subproject.amount_of_care_and_maintenance_fund_raised_and_deposited_in_the_village_account = amount_of_care_and_maintenance_fund_raised_and_deposited_in_the_village_account
                        subproject.existence_of_a_maintenance_and_upkeep_plan_developed_by_the_Community = bool(existence_of_a_maintenance_and_upkeep_plan_developed_by_the_Community) if existence_of_a_maintenance_and_upkeep_plan_developed_by_the_Community else False
                        subproject.date_of_technical_acceptance_of_work_contracts = date_of_technical_acceptance_of_work_contracts
                        subproject.technical_acceptance_date_for_furniture_and_equipment_supply_contracts = technical_acceptance_date_for_furniture_and_equipment_supply_contracts
                        subproject.date_of_provisional_acceptance_of_work_contracts = date_of_provisional_acceptance_of_work_contracts
                        subproject.provisional_acceptance_date_for_furniture_and_equipment_supply_contracts = provisional_acceptance_date_for_furniture_and_equipment_supply_contracts
...
(Si Oui mettre 1; Si non mettre 0)""": {},
    ...
    for elt in Subprojects:
        ...
        datas["NOM DE L'ENTREPRISE ATTRIBUTAIRE ENTREPRISES DE FOURNITURE DE MOBILIERS ET EQUIPEMENTS (EFME)"][count] = elt.name_of_the_winning_company_enterprises_of_supply_of_furniture_and_equipment
        datas["DATE SIGNATURE CONTRAT ENTREPRISES DE FOURNITURE DE MOBILIERS ET EQUIPEMENTS (EFME)"][count] = elt.date_signature_contract_companies_supply_of_furniture_and_equipment
        datas["MONTANT DU CONTRAT ENTREPRISES DE FOURNITURE DE MOBILIERS ET EQUIPEMENTS (EFME)"][count] = elt.amount_of_the_contract_companies_for_the_supply_of_furniture_and_equipment
...
(Travaux en cours, Arrêt travaux, Abandon travaux, Réception technique, Réception provisoire etc,)"""][count] = elt.current_status_of_the_site
        ...
        datas["MONTANT DU FONDS D'ENTRETIEN ET DE MAINTENANCE (EMI)  MOBILISE ET DEPOSE SUR LE COMPTE DU VILLAGE"][count] = elt.amount_of_care_and_maintenance_fund_raised_and_deposited_in_the_village_account
        datas["""Existence d'un Plan d'Entretien et de Maintenance (Plan EMI) élaboré par la Communauaté 
(Si Oui mettre 1; Si non mettre 0)"""][count] = 1 if elt.existence_of_a_maintenance_and_upkeep_plan_developed_by_the_Community else 0
        ...
        datas["DATES DE RECEPTION TECHNIQUE DES MARCHE DE FOURNITURE DE MOBILIERS ET EQUIPEMENTS"][count] = elt.technical_acceptance_date_for_furniture_and_equipment_supply_contracts
        ...
        datas["DATES DE RECEPTION PROVISOIRE DES MARCHE DE FOURNITURE DE MOBILIERS ET EQUIPEMENTS"][count] = elt.provisional_acceptance_date_for_furniture_and_equipment_supply_contracts
